...
Generated JSON Schemas for authoritative input, process, Domain output, and
Pipeline integration result contracts are committed here. They are reviewable
public file contracts derived from the closed Pydantic models.
