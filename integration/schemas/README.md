...
Generated JSON Schemas for authoritative input, process, and output contracts are
committed here. They are reviewable public file contracts derived from the closed
Pydantic models.
